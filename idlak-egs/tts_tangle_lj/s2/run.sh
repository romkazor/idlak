...
stage=-1
endstage=7
nj=4 # Avoid putting more than 9, may not work
# Speaker ID
spks=LJ
network_type=dnn # nn or lstm
...
export featdir=$TMPDIR/dnn_feats/ljf
############################################
...
################################
## 4. Align with full labels ##
################################

if [ $stage -le 4 ]; then
    echo -e "\n\n##### Step 4: Generating input features from aligned labels #####\n"
